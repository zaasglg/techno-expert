...
export default function Brands({ brands }: { brands: { data: any[], links: any[] } }) {
    ...
    const handleImport = () => {
        if (confirm('Импортировать все бренды из API? Текущие данные будут удалены.')) {
            setLoading(true);
            router.post('/admin/brands/import', {}, {
            ...
            <div className="wrapper">
                ...
                <div className="content-wrapper">
                    ...
                    <section className="content">
                        <div className="card">
                            <div className="card-header">Управление брендами</div>
                        ...
                        <div className="card">
                            <div className="card-header">Список брендов</div>
                            <div className="card-body">
